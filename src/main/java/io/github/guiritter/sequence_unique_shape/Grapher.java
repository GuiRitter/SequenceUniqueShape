...
public final class Grapher {
	...
	public final Distance distanceCalculator = new Distance();

	private String fileName;

	private String fileNameDistance;
	...
	public void graph(int sequence[]) throws IOException {
		...
		fileNameSequence = stripArrayToStringFormatCharacter(Arrays.toString(sequence));
