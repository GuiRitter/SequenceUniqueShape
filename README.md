...
For sequences of 8 numbers, sequence generation went from 8.1 seconds to 1.2 seconds. It managed to find sequences of 9 numbers. I predicted 894 sequences and found 1219 after 12 seconds. Funny thing is, I managed to break the 9 numbers barrier only to hit another barrier at 10 numbers... Instead of a `java.lang.OutOfMemoryError: Java heap space`, I got a `java.lang.OutOfMemoryError: GC overhead limit exceeded`. I'm generating way too much `LinkedList`s out of fear of leaking references. I'll have to optimize that part of the code to go further.
